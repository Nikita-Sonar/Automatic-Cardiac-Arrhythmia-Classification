...
frame_alpr = tk.LabelFrame(text="  ", width=750, height=700, bd=5, font=('times', 14, ' bold '),bg="white")
...
btn = tk.Button(window, text="Create Account", bg="green",font=("",20),fg="Black", width=15, height=0, command = insert)
